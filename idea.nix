				...
				"false" =
					{
						"f9b1202d9e218ecb6041ddca6aad80d2e100babd6f2cfba639db1fef0ea56cc2b7be2eba8aaf0d4dd068044c337e541e1d86028feee0573e8af2ab0f6748fa13" =
							[
								(
									{ derivation , grandparent-pid , harvest , is-file , is-interactive , is-pipe , path , parent-pid , resource , script , shell-script , standard-input , string , target , write-shell-script } :
										{
											init =
												script
													{
														...
														sets =
															[
																...
																( string "TEMPLATE_FILE" "/nix/store/g3ipf42sx0nm5mpx5cxmdsr7brxlhqvl-source/scripts/test/temporary/init.json" )
												...
												script
													{
														...
														sets =
															[
																...
																( string "TEMPLATE_FILE" "/nix/store/g3ipf42sx0nm5mpx5cxmdsr7brxlhqvl-source/scripts/test/temporary/release.json" )
																( derivation "TEMPORARY_TOKEN" ( harvest : harvest.temporary.util.token ) )
																( string "YQ" "${ yq }" )
															] ;
													} ;
