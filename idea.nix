												...
												script
													{
														...
														sets =
															[
																...
																( string "TEMPLATE_FILE" "/nix/store/ag99ngafnn5dqqzliyrgmlz9wd3mjps4-source/scripts/test/temporary/init.json" )
												...
												script
													{
														...
														sets =
															[
																...
																( string "TEMPLATE_FILE" "/nix/store/ag99ngafnn5dqqzliyrgmlz9wd3mjps4-source/scripts/test/temporary/release.json" )
																( derivation "TEMPORARY_TOKEN" ( harvest : harvest.temporary.util.token ) )
																( string "YQ" "${ pkgs.yq }/bin/yq" )
															] ;
													} ;
