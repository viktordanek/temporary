		...
		"0" =
			{
				"false" =
					{
						"1504d2e9be0e5b88c53cd153273583ee757ebb1355044e3e7be673f26695462d1c6b8ee23435e5ea07d2b51334592300310a3d19e83904ba4081075049aeccef" =
							{
																		...
																		script
																			{
																				...
																				sets =
																					[
																						...
																						( string "TEMPLATE_FILE" "/nix/store/df8pbibzr4ql7ih3yccas19y8nmh71yf-source/scripts/test/temporary/init.json" )
																		...
																		script
																			{
																				...
																				sets =
																					[
																						...
																						( string "SEED" "5de1c132a311be195cb605b4c418dd9f71bb9d409f0b538a80c1185a58c0c46dd3015916afe8e2deb1dd58dd65fe31f95cc8d992aa9ca0e3665326d0a333d9cb" )
																		...
																		script
																			{
																				...
																				sets =
																					[
																						...
																						( string "TEMPLATE_FILE" "/nix/store/df8pbibzr4ql7ih3yccas19y8nmh71yf-source/scripts/test/temporary/release.json" )
																						( derivation "TEMPORARY_TOKEN" ( harvest : harvest.temporary.util.token ) )
																						( string "YQ" "${ pkgs.yq }/bin/yq" )
																					] ;
																			} ;
