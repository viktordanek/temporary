												...
												script
													{
														...
														sets =
															[
																...
																( string "TEMPLATE_FILE" "/nix/store/jfqkw0sqwz7xal0n51jvr4y0dp6054q2-source/scripts/test/temporary/init.json" )
												...
												script
													{
														...
														sets =
															[
																...
																( derivation "OBSERVED" ( harvest : harvest.temporary.util.observed ) )
																...
																( string "SHA512SUM" "${ pkgs.yq }/bin/sha512sum" )
