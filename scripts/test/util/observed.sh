${MKDIR} --parents /build/observed/temporary &&
  ...
  if [ -f ${T1} ]
  then
    ${ECHO} PASTE=e83f3c739d0d155db02acce1e98e6b2ac3d0c0c9d965f80118e122401f74e33ff42942716c729ce8e45ab9ecd2d97ef868bffefc0fae56d79efe5c9438a44f1c PIPE ${T1} >> /build/observed/debug
  else
    ${ECHO} WTF4 >> /build/observed/debug
  fi