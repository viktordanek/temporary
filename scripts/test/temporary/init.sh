TARGET=${e55dd2c8db9b224d0d6207c430354f481ece26fbf458400726e7624bcc79fcb72de81bccc55a066ebfa569317862dec4b13ea6bb4b1e8b0300f1dc867e51503d} &&
  ...
  ${ECHO} I_INIT_ARGUMENT_STATUS=${INIT_ARGUMENT_STATUS} >> ${TARGET} &&
  ${ECHO} I_INIT_STANDARD_INPUT_ARGUMENT_STATUS=${INIT_STANDARD_INPUT_STATUS} >> ${TARGET} &&
  ${ECHO} I_INIT_EXIT_STATUS=${INIT_EXIT_STATUS} >> ${TARGET} &&
  ${ECHO} I_RELEASE_EXIT_STATUS=${RELEASE_EXIT_STATUS} >> ${TARGET} &&
  ${ECHO} I_VARIABLE=${VARIABLE} >> ${TARGET} &&
  exit ${A_INIT_EXIT_STATUS}