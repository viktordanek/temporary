TARGET=${e55dd2c8db9b224d0d6207c430354f481ece26fbf458400726e7624bcc79fcb72de81bccc55a066ebfa569317862dec4b13ea6bb4b1e8b0300f1dc867e51503d} &&
  ...
  A_INIT_STANDARD_OUTPUT=${INIT_STANDARD_OUTPUT} &&
  A_INIT_STANDARD_ERROR=${TEMPORARY_PATH_ARRAY[3} &&
  A_INIT_EXIT=${TEMPORARY_PATH_ARRAY[4]: -1} &&
  A_RELEASE_TYPEOF=${TEMPORARY_PATH_ARRAY[5]} &&
  A_RELEASE_STANDARD_OUTPUT=${TEMPORARY_PATH_ARRAY[6]} &&
  A_RELEASE_STANDARD_ERROR=${TEMPORARY_PATH_ARRAY[7]} &&
  A_RELEASE_EXIT=${TEMPORARY_PATH_ARRAY[8]: -1} &&
