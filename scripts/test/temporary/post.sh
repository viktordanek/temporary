TEMPORARY_PATH=${bdc6a3ee36ba1101872a7772344634fb07cf5dee5e77970db3dee38e697c0c1379d433ea03d0b61975f8d980d3dcc3c6516ff67db042cacf10cb3c27be1faf9b}
  ...
  A_INIT_STANDARD_OUTPUT=${TEMPORARY_PATH_ARRAY[4]} &&
  A_INIT_STANDARD_ERROR=${TEMPORARY_PATH_ARRAY[5]} &&
  A_RELEASE_STANDARD_OUTPUT=${TEMPORARY_PATH_ARRAY[6]} &&
  A_RELEASE_STANDARD_ERROR=${TEMPORARY_PATH_ARRAY[7]} &&
