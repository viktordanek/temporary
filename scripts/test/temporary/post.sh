TEMPORARY_PATH=${bdc6a3ee36ba1101872a7772344634fb07cf5dee5e77970db3dee38e697c0c1379d433ea03d0b61975f8d980d3dcc3c6516ff67db042cacf10cb3c27be1faf9b}
  ...
  INIT_TOKEN_ARGUMENTS=$( ${ECHO} "${INIT_VARIABLE} standard input" | ${SHA512SUM} | ${CUT} --bytes -128 ) &&
  ...
  ${SED} \
    ...
    -e "s#^I_TOKEN_ARGUMENTS=.*\$#I_TOKEN_ARGUMENTS=wrong#" \
    -e "s#^I_TOKEN_STANDARD_INPUT=.*\$#I_TOKEN_ARGUMENTS=${INIT_TOKEN_STANDARD_INPUT}#" \
