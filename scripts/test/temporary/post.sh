TEMPORARY_PATH=${bdc6a3ee36ba1101872a7772344634fb07cf5dee5e77970db3dee38e697c0c1379d433ea03d0b61975f8d980d3dcc3c6516ff67db042cacf10cb3c27be1faf9b}
  ...
  DIRECTORY=/build/observed/temporary/${INIT_ARGUMENT_STATUS}/${A_INIT_STANDARD_INPUT}/${A_INIT_STANDARD_ERROR}/${INIT_EXIT_STATUS}/${RELEASE_EXIT_STATUS} &&
  ...
  ${SED} -e "s#^INIT_STANDARD_ERROR=.*\$#INIT_STANDARD_ERROR=${A_INIT_STANDARD_ERROR}#" -e w${DIRECTORY}/standard-error.post ${DIRECTORY}/standard-error &&
  ${DIFF} --brief --report-identical-files ${DIRECTORY}/standard-error ${DIRECTORY}/standard-error.post > ${DIRECTORY}/standard-error.diff &&
  ${SED} \
