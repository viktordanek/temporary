TEMPORARY_PATH=${bdc6a3ee36ba1101872a7772344634fb07cf5dee5e77970db3dee38e697c0c1379d433ea03d0b61975f8d980d3dcc3c6516ff67db042cacf10cb3c27be1faf9b}
  ...
  ${SED} \
    ...
    -e "s#^I_TOKEN_11=.*\$#I_TOKEN_11=w${INIT_TOKEN_11}#" \
    -e "s#^I_TOKEN_12=.*\$#I_TOKEN_12=w${INIT_TOKEN_12}#" \
    -e "s#^I_TOKEN_13=.*\$#I_TOKEN_13=w${INIT_TOKEN_13}#" \
    -e "s#^I_TOKEN_14=.*\$#I_TOKEN_14=w${INIT_TOKEN_14}#" \
