TARGET=${e55dd2c8db9b224d0d6207c430354f481ece26fbf458400726e7624bcc79fcb72de81bccc55a066ebfa569317862dec4b13ea6bb4b1e8b0300f1dc867e51503d} &&
  ...
  ${ECHO} RELEASE_TOKEN_11=$( ${CAT} $( ${TOKEN_1} ) ) >> ${TARGET} &&
  ${ECHO} RELEASE_TOKEN_12=$( ${CAT} $( ${TOKEN_1} ${TOKEN_ARGUMENTS} ) ) >> ${TARGET} &&
  ${ECHO} RELEASE_TOKEN_13=$( ${CAT} $( ${ECHO} ${TOKEN_STANDARD_INPUT} | ${TOKEN_1} ) ) >> ${TARGET} &&
  ${ECHO} RELEASE_TOKEN_14=$( ${CAT} $( ${ECHO} ${TOKEN_STANDARD_INPUT} | ${TOKEN_1} ${TOKEN_ARGUMENTS} ) ) >> ${TARGET} &&
  exit ${STATUS}