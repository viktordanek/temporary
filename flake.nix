                                                                                                                ...
                                                                                                                sets =
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        TEMPLATE_FILE = builtins.toFile "expected.json" ( builtins.replaceStrings [ "\"env(ARGUMENTS)\"" "\"env(STANDARD_ERROR)\"" "\"env(STANDARD_OUTPUT)\"" ] [ "$ARGUMENTS" "$STANDARD_ERROR" "$STANDARD_OUTPUT" ] ( ( builtins.toJSON ( builtins.import ( self + "/templates/method.yaml" ) ) ) ) ) ;
                                                                                                                        YQ = "${ pkgs.yq }/bin/yq" ;
                                                                                                                    } ;
                                                                                                            } ;
                                                                                                } ;
