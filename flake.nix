                                                                                            ...
                                                                                            [
                                                                                                ...
                                                                                                (
                                                                                                    ...
                                                                                                    then
                                                                                                        ...
                                                                                                        then
                                                                                                            builtins.concatLists ( builtins.attrValues ( builtins.mapAttrs ( name : value : [ "--set ${ name } ${ builtins.trace "HI! value is a ${ builtins.typeOf value } ;" ( builtins.typeOf value ) }" ] ) sets ) )
