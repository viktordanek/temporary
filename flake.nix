                                                                    ...
                                                                    path : name : value :
                                                                        if builtins.typeOf value == "set" then builtins.concatLists ( builtins.attrValues ( builtins.mapAttrs ( mapper ( builtins.concatLists [ path [ name ] ] ) ) value ) )
                                                                            ...
                                                                            let
                                                                                ...
                                                                                in [ "#" ( builtins.concatStringsSep " " [ "${ pkgs.coreutils }/bin/echo" ( builtins.concatStringsSep " / " path ) ">&2" ] ) status status ]
                                                                 ...
                                                                 in
                                                                    ''
                                                                        ${ pkgs.coreutils }/bin/mkdir $out &&
                                                                            ...
                                                                            ${ pkgs.coreutils }/bin/ln --symbolic ${ pkgs.writeShellScript "observed-internal" ( builtins.concatStringsSep " &&\n" [ "${ pkgs.coreutils }/bin/echo MASTER_PS=$$" ( builtins.concatLists ( builtins.attrValues ( builtins.mapAttrs ( mapper [ "resources" "temporary" ] ) resources.temporary.temporary ) ) ) ] ) } $out/bin/observed-internal.sh &&
                                                                            ...
                                                                            ${ pkgs.findutils }/bin/find /build -name "*.pid" -exec ${ pkgs.coreutils }/bin/cat {} \; &&
