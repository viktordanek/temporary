                                                                ...
                                                                rand =
                                                                    string :
                                                                        let
                                                                            ...
                                                                            in builtins.foldl' ( previous : next : previous + next ) 0 ( builtins.genList ( index : builtins.fromJSON ( builtins.substring index ( index ( index + 1 ) str ) ) ) ( builtins.stringLength str ) ) ;
                                                                values =
                                                                    {
