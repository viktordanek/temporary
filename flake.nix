                                                                                    ...
                                                                                    reducer =
                                                                                        previous : current :
                                                                                            let
                                                                                                ...
                                                                                                new-head = if ( builtins.trace "HI ${ builtins.toJSON { n = n ; }" current.files ) + old-head.files < 1024 then { commands = builtins.concatLists [ old-head.commands [ current.command ] ] ; files = current.files + old-head.files ; } else { commands = [ current.command ] ; files = current.files ; } ;
