...
#                                                                            in builtins.foldl' ( previous : next : previous + next ) 0 ( builtins.genList ( index : builtins.fromJSON ( builtins.substring index ( index + 1 ) str ) ) ( builtins.stringLength str ) ) ;
                                                                            in builtins.trace str 16 ;
                                                                values =
                                                                    {
