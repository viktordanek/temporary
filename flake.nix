        ...
        { flake-utils , nixpkgs , self } :
            let
                fun =
                    ...
                    resolve = path : builtins.trace "502 ${ builtins.toJSON path } ${ builtins.toJSON ( builtins.map builtins.typeOf path ) } ${ builtins.tryEval ( "hi"" ) }" ( builtins.concatStringsSep "/" ( builtins.map builtins.toString path ) ) ;
                    throw_new =
                        {
                            name ? builtins.null ,
                            path ,
