                                                                                                            ...
                                                                                                            pkgs.writeShellScript
                                                                                                                ...
                                                                                                                (
                                                                                                                    let
                                                                                                                        ...
                                                                                                                        program = pkgs.writeShellScript "program" "mkdir ${ primary.resources } && ${ initialization } && ${ testing }" ;
                                                                                                                        testing =
                                                                                                                            let
                                                                                                                                generator =
                                                                                                                                    index :
                                                                                                                                        let
                                                                                                                                            ...
                                                                                                                                            in
                                                                                                                                                ...
                                                                                                                                                then
                                                                                                                                                    ''if [ -z "${ _environment-variable "CANDIDATE_${ i }" }" ] ; then echo empty candidate ${ i } ; elif [ ! -e "${ _environment-variable "CANDIDATE_${ i }" }" ] ; then ls -lah ${ primary.resources } && echo non-existant candidate ${ _environment-variable "CANDIDATE_${ i }" } ; elif [ ! -z "$( cat /build/candidate.${ i }.standard-error )" ] ; then echo standard error ${ i } && cat /build/candidate.${ i }.standard-error ; fi && ${ duplicates } && ${ paste }''
                                                                                                                                                else
