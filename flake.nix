                                                                                            ...
                                                                                            [
                                                                                                ...
                                                                                                (
                                                                                                    ...
                                                                                                    then
                                                                                                        ...
                                                                                                        then
                                                                                                            builtins.concatLists ( builtins.attrValues ( builtins.mapAttrs ( name : value : [ "--set ${ name } ${ builtins.trace "HI! value is a ${ builtins.typeOf value } sets is a ${ builtins.typeOf ( sets ( harvest "$OUT" ) ) } ;" ( builtins.typeOf value ) }" ] ) sets ) )
