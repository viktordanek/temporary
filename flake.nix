...
#                                                                                                        else builtins.throw "The level ${ current } is unexpected." ;
                                                                                                        ...
                                                                                                        else if builtins.any ( c : current == c ) [ "init-typeOf" "release-typeOf" ] then builtins.concatLists [ ( builtins.map ( p : p // { "${ current }" = 0 ; } ) previous ) ( builtins.map ( p : p // { "${ current }" = 2 ; } ) previous ) ]
                                                                                                        else builtins.throw "The level ${ current } is unexpected." ;
