                                                        ...
                                                        path : name : value :
                                                            if builtins.typeOf value == "lambda" then "${ builtins.concatStringsSep "/" ( builtins.concatLists [ path [ name ] ] ) }/setup"
                                                                ...
                                                                let
                                                                    ...
                                                                    in builtins.trace "HIH ${ builtins.toJSON ( generator 0 ) } ${ name } ${ builtins.typeOf value } ${ builtins.toString ( builtins.length value ) }" ( builtins.genList generator ( builtins.length value ) )
