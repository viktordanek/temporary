                                                        ...
                                                        installPhase =
                                                            ''
                                                                ${ pkgs.coreutils }/bin/mkdir $out &&
                                                                    ...
                                                                    makeWrapper $out/bin/re-observate.sh $out/bin/re-observate --set BASH ${ pkgs.bash }/bin/bash --set GREP ${ pkgs.gnugrep }/bin/grep --set SLEEP ${ pkgs.coreutils }/bin/sleep &&
