                                                                                    ...
                                                                                    mapper =
                                                                                        path : name : value :
                                                                                            if builtins.typeOf value == "list" then
                                                                                                let
                                                                                                    generator = index : builtins.trace ( builtins.toJSON { index = index ; path = path ; length = builtins.length value ;} ) { index = builtins.toString index ; init-status = builtins.elemAt path 0 ; seed = builtins.elemAt path 1 ; } ;
