                                                                                        ...
                                                                                        reducer =
                                                                                            previous : current :
                                                                                                let
                                                                                                    ...
                                                                                                    in
                                                                                                        if builtins.any ( c : current == c ) [ "init-standard-output" "init-standard-error" "release-standard-output" "release-standard-error" ] then [ ( builtins.map ( p : p // { "${ current }" = 0 ; } ) previous ) ]
                                                                                                        else if builtins.any ( c : current == c ) [ "arguments" "standard-input" "init-status" "release-status" ] then [ ( builtins.map ( p : p // { "${ current }" = 0 ; } ) previous ) ]
                                                                                                        else if builtins.any ( c : current == c ) [ "init-typeOf" "release-typeOf" ] then [ ( builtins.map ( p : p // { "${ current }" = 0 ; } ) previous ) ]
