                            ...
                            lib =
                                {
                                    ...
                                    let
                                        ...
                                        resolve = path : name : builtins.concatStringsSep "/" ( builtins.map builtins.toString [ ( builtins.hashString "sha512" ( builtins.concatStringsSep "" ( builtins.map builtins.fromJSON ( builtins.concatLists [ path [ name ] ] ) ) ) ) ] ) ;
                                        in harvest ;
