                                                                                        ...
                                                                                        "0" =
                                                                                            {
                                                                                                ...
                                                                                                "0" =
                                                                                                    script :
                                                                                                        {
                                                                                                            init = script { executable = pkgs.writeShellScript "temporary-init.sh" ( builtins.readFile ( self + "/scripts/test/temporary/init.sh" ) ) ; sets = { ECHO = "${ pkgs.coreutils }/bin/echo" ; INIT_EXIT_CODE = "0" ; STANDARD_ERROR = "7cc1c238512a2ef539d1a449c0bf25a1bdcdb438167863af722155dc077b102edca8b36922989ccc06b31da75551ead3aaea3ef977848874130c121ce0e847a4" ; STANDARD_OUTPUT = "7d67ac07d63ef9145d392a657cec5c22075d8bcc93e910143a468d3833abf05c9fccb36ae6e1ec64344cea62fadd9684d99615ad646c8aa6b6935bf35b0e9266" ; TEE="${ pkgs.coreutils }/bin/tee" ; VARIABLE = "7a09c789507b0564945c2fce0e0e42c6e574dd7a1ef2201b0344ca57a4fd65f3e7347a49622ed16793611eb9ae3c54cdf4d52cf3f04f0be3da814b359db159fb" ; } ; } ;
                                                                                                            release = script { executable = pkgs.writeShellScript "temporary-release" ( self + "/scripts/test/temporary/release.sh" ) ; sets = { ECHO = "${ pkgs.coreutils }/bin/echo" ; RELEASE_EXIT_CODE = "0" ; } ; } ;
                                                                                                            post = script { executable = pkgs.writeShellScript "temporary-post" ( self + "/scripts/test/temporary/post.sh" ) ; sets = { CAT = "${ pkgs.coreutils }/bin/cat" ; MKDIR = "${ pkgs.coreutils }/bin/mkdir" ; } ; } ;
                                                                                                        } ;
                                                                                            } ;
                                                                                    } ;
                                                                            } ;
