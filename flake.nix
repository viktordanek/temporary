                                                                                                                                                    ...
                                                                                                                                                    "0" =
                                                                                                                                                        {
                                                                                                                                                            ...
                                                                                                                                                            "0" =
                                                                                                                                                                script :
                                                                                                                                                                    {
                                                                                                                                                                        init = script { executable = pkgs.writeShellScript "temporary-init" ( builtins.readFile ( self + "/scripts/test/temporary/init.sh" ) ) ; sets = harvest : { ECHO = "${ pkgs.coreutils }/bin/echo" ; INIT_EXIT_CODE = "0" ; TEE="${ pkgs.coreutils }/bin/tee" ; TOKEN = "" ; VARIABLE = "7a09c789507b0564945c2fce0e0e42c6e574dd7a1ef2201b0344ca57a4fd65f3e7347a49622ed16793611eb9ae3c54cdf4d52cf3f04f0be3da814b359db159fb" ; } ; } ;
