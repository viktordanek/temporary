                                                ...
                                                post =
                                                    if builtins.typeOf post == "null" then post
                                                        ...
                                                        let
                                                            ...
                                                            in if builtins.trace "? ${ builtins.toJSON eval.success }" eval.success then builtins.trace ( builtins.concatStringsSep ";" ( builtins.attrNames eval.value ) ) eval.value else builtins.throw "There was a problem evaluating post."
