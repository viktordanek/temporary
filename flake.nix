                                                                                ...
                                                                                temporary =
                                                                                    {
                                                                                        ...
                                                                                        observe =
                                                                                            let
                                                                                                ...
                                                                                                mapper =
                                                                                                    value : { derivation , harvest , script , write-shell-script , ... } :
                                                                                                        {
                                                                                                            init =
                                                                                                                script
                                                                                                                    {
                                                                                                                            ...
                                                                                                                            let
                                                                                                                                mapper =
                                                                                                                                    { command , handles , status } :
                                                                                                                                        ''${ pkgs.coreutils }/bin/echo ${ derivation "WTF" ( harvest : harvest.temporary.util.token ) } if ! ${ command harvest } ; then ${ pkgs.coreutils }/bin/false ; fi'' ;
