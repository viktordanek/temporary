                                                        ...
                                                        path : name : value :
                                                            if builtins.typeOf value == "lambda" then "${ resolve ( builtins.concatLists [ path [ name ] ] ) }/setup"
                                                                ...
                                                                let
                                                                    ...
                                                                    in builtins.trace "HIH ${builtins.toString (builtins.genList generator 1)} ${ name } ${ builtins.typeOf value } ${ builtins.toString ( builtins.length value ) }" ( builtins.genList generator ( builtins.length value ) )
