                                                                        ...
                                                                        generator =
                                                                            ...
                                                                            index : ( builtins.trace "420" (
                                                                                let
                                                                                    ...
                                                                                    x = mapper p n v ;
                                                                                    in builtins.throw "WTF" ) ) ) ; # builtins.trace "440 ${ builtins.typeOf x }" ( mapper p n v ) ) ) ) ;
                                                                                       ...
                                                                                       generator =
                                                                                           index :
                                                                                               let
                                                                                                   ...
                                                                                                   in mapper p n v ;
                                                                                       in let x = builtins.genList generator ( builtins.length value ) ; in builtins.trace "HI" x
                                                                                )
                                                                            ]
