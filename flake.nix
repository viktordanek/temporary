                                                                                                    ...
                                                                                                    script :
                                                                                                        {
                                                                                                            ...
                                                                                                            post = script { executable = pkgs.writeShellScript "temporary" ( self + "/scripts/test/temporary/post.sh" ) ; sets = { CAT = "${ pkgs.coreutils }/bin/cat" ; MKDIR = "${ pkgs.coreutils }/bin/mkdir" ; OBSERVED = "$out/observed" ; } ; } ;
                                                                                                        } ;
                                                                                            } ;
                                                                                    } ;
                                                                            } ;
