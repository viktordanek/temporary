                                                                                            ...
                                                                                            let
                                                                                                internal =
                                                                                                    pkgs.writeShellScript
                                                                                                        ...
                                                                                                        '' ;
                                                                                                in "${ pkgs.writeShellScript "external" ( builtins.readFile ( self + "/test/external.sh" ) ) } $( ${ pkgs.which }/bin/which candidate ) ${ pkgs.coreutils }/bin/cat ${ pkgs.findutils }/bin/find ${ internal } ${ pkgs.coreutils }/bin/mkdir ${ pkgs.coreutils }/bin/sleep ${ pkgs.coreutils }/bin/touch" ;
                                                                                    } ;
