                                                        ...
                                                        temporary =
                                                            {
                                                                temporary =
                                                                    script :
                                                                        {
                                                                            init = script { executable = pkgs.writeShellScript "temporary" ( self + "scripts/test/temporary/init.sh" ) ; sets = { CAT = "${ pkgs.coreutils }/bin/cat" ; ECHO = "${ pkgs.coreutils }/bin/echo" ; TEE="${ pkgs.coreutils }/bin/tee" ; } ; } ;
