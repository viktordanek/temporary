                                                                            ...
                                                                            in
                                                                                ...
                                                                                [
                                                                                    ...
                                                                                    [
                                                                                        ...
                                                                                        "makeWrapper ${ builtins.concatStringsSep "/" path }/${ name }/setup.sh ${ builtins.concatStringsSep "/" path }/${ name }/setup --set COREUTILS ${ pkgs.coreutils } --set STORE ${ builtins.concatStringsSep "/" path }/${ name } --set TEARDOWN ${ self + "/scripts/implementation/teardown.sh" } --set TEMPORARY_RESOURCE_MASK ${ temporary-resource-mask }"
                                                                                    ]
                                                                                ]
