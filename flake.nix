    ...
    inputs =
        {
            ...
            shell-script.url = "github:viktordanek/shell-script/scratch/bf45cd3c-30b4-443b-84e6-ffb8c5d4297e" ;
                                                ...
                                                release :
                                                    {
                                                        failure =
                                                            ignore :
                                                                {
                                                                    archive = self + "/expected/setup/failure/mounts/archive/${ builtins.toJSON release }" ;
