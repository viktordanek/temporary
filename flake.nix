                                                            ...
                                                            injection =
                                                                {
                                                                    ...
                                                                    transient = name : fun : "--set ${ name } ${ fun harvest }" ;
                                                                } ;
                                                            write-shell-script =
                                                                { executable ? null , executablePath ? null , environment ? { } : null } :
                                                                    {
                                                                                                        ...
                                                                                                        environment =
                                                                                                            { resource , string , transient , ... } :
                                                                                                                [
                                                                                                                    ...
                                                                                                                    ( transient "POST" ( transient : builtins.trace ( builtins.concatStringsSep " ; " ( builtins.attrNames transient.derivation ) ) transient.derivation.util ) )
