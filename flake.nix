                                                                                                                            ...
                                                                                                                            let
                                                                                                                                mapper =
                                                                                                                                    { command , handles , status } :
                                                                                                                                        ''${ pkgs.coreutils }/bin/echo WTF=$( ${ pkgs.coreutils }/bin/dirname $( ${ pkgs.coreutils }/bin/readlink ${ builtins.concatStringsSep "" [ "$" "{" "0" "}" ] } ) ) ${  COMMAND=${ command harvest } > ${ builtins.concatStringsSep "" [ "$" "{" "TARGET" "}" ] }'' ;
