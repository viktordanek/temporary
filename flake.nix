                                                                                        ...
                                                                                        let
                                                                                            ...
                                                                                            levels =
                                                                                                let
                                                                                                        ...
                                                                                                        path : name : value :
                                                                                                            if builtins.typeOf value == "null" then
                                                                                                                let
                                                                                                                    script = null ;
                                                                                                                    in [ script ]
                                                                                                            else if builtins.typeOf value == "set" then builtins.throw "WTF" # builtins.concatLists ( builtins.mapAttrs ( mapper ( builtins.concatLists [ path [ name ] ] ) ) value )
                                                                                                    ...
                                                                                                    in builtins.mapAttrs ( mapper [ ] ) levels ;
