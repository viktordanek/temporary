                                                                                                ...
                                                                                                builtins.concatLists
                                                                                                    [
                                                                                                        [
                                                                                                                            ...
                                                                                                                            generator =
                                                                                                                                index :
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        "if [ ${ secondary.verbose } ] || [ ${ builtins.concatStringsSep "" [ "$" "{" "TEMPORARY_STATUS" "}" ] } != 0 ] ; then echo ${ builtins.concatStringsSep "" [ "$" "{" "TEMPORARY_STATUS" "}" ] } >> /post/temporary.status ; fi"
                                                                                                                                        ...
                                                                                                                                        ''if [ ${ secondary.verbose } ] || [ ! -z "${ builtins.concatStringsSep "" [ "$" "{" "PASTE_STANDARD_INPUT" "}" ] }" ] ; then cat ${ builtins.concatStringsSep "" [ "$" "{" "PASTE_STANDARD_INPUT" "}" ] } >> /post/paste.standard-input ; fi''
                                                                                                            ...
                                                                                                            "makeWrapper ${ builtins.concatStringsSep "/" ( builtins.concatLists [ [ "$out" "test" ] ( builtins.map builtins.toJSON path ) [ "outer.sh" ] ] ) } ${ builtins.concatStringsSep "/" ( builtins.concatLists [ [ "$out" "test" ] ( builtins.map builtins.toJSON path ) [ "outer" ] ] ) }"
                                                                                                        ]
                                                                                                    ] ;
                                                                            }
                                                                            {
