                                                        ...
                                                        temporary =
                                                            {
                                                                temporary =
                                                                    let
                                                                        reducer = previous : current : builtins.trace "HI - ${ builtins.toString ( builtins.length ( builtins.attrNames current.set ) ) } - ${ builtins.typeOf ( lib ) } " ( lib.recursiveUpdate previous current.set ) ;
