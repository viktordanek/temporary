                                                                                            ...
                                                                                            previous : current :
                                                                                                let
                                                                                                    ...
                                                                                                    in
                                                                                                        ...
                                                                                                        else if builtins.any ( c : current == c ) [ "arguments" "standard-input" "init-status" "release-status" ] then builtins.trace "FOUND IT 2 ${ current } ${ builtins.typeOf ( builtins.genList generator 2 ) }" ( builtins.genList generator 2 )
