                                                        ...
                                                        temporary =
                                                            {
                                                                temporary =
                                                                    let
                                                                        reducer = previous : current : builtins.trace "HI ${ builtins.typeOf previous } ${ builtins.typeOf current } ${ builtins.concatStringsSep "" ( builtins.attrNames current ) }" ( lib.mergeAttrs previous current.set ) ;
                                                        ...
                                                        { index , arguments , standard-input , init-typeOf , init-standard-output , init-standard-error , init-status , release-typeOf , release-standard-output , release-standard-error , release-status } :
                                                            let
                                                                ...
                                                                in
                                                                {
                                                                    ...
                                                                    set =
                                                                        {
                                                                            "${ arguments }"."${ standard-input }"."${ init-typeOf }"."${ init-standard-output }"."${ init-status }"."${ release-typeOf }"."${ release-standard-output }"."${ release-standard-error }"."${ release-status }" =
                                                                                script :
                                                                                    let
                                                                                        sets =
                                                                                            {
