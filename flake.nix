                                                                ...
                                                                mapper2 =
                                                                    path : name : value :
                                                                        if builtins.typeOf value == "set" then builtins.concatLists ( builtins.attrValues ( builtins.mapAttrs ( mapper2 ( builtins.concatLists [ path [ name ] ] ) ) value ) )
                                                                            ...
                                                                            let
                                                                                arguments = "${ builtins.concatStringsSep "" [ "$" "{" " " "resources" " " "." " " "temporary" " " "." " " "temporary" " " . " " ( builtins.concatStringsSep " . " ( builtins.map ( x : builtins.concatStringsSep "" [ "\"" x "\"" ] ) ( builtins.concatLists [ path [ name ] ] ) ) ) " " "}" ] } ${ builtins.elemAt path 1 }" ;
                                                                                echo = builtins.concatStringsSep "" [ "$" "{" " " "echo" " " "}" ] ;
                                                                                standard-input =
                                                                                    let
