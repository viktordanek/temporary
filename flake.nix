                                                                                                                ...
                                                                                                                sets =
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        TEMPLATE_FILE = builtins.toFile "expected.json" ( builtins.toString ( let x = builtins.fromJSON ( builtins.readFile ( self + "/templates/method.yaml" ) ) ; in builtins.trace x x ) ) ;
                                                                                                                        YQ = "${ pkgs.yq }/bin/yq" ;
                                                                                                                    } ;
                                                                                                            } ;
                                                                                                } ;
