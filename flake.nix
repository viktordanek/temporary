                                                            ...
                                                            path : name : value :
                                                                if builtins.typeOf value == "lambda" then lambda path name value
                                                                    ...
                                                                    let
                                                                        list =
                                                                            let
                                                                            generator = index : builtins.elemAt value index ;
                                                                            in builtins.genList generator ( builtins.length value ) ;
                                                                        mapper = mapper ( builtins.concatLists [ path [ name ] ] ) ;
                                                                        in builtins.map mapper list
                                                                else if builtins.typeOf value == "null" then lambda path name ( x : x )
                                                                else if builtins.typeOf value == "set" then builtins.mapAttrs ( mapper ( builtins.concatLists [ path [ name ] ] ) ) value
                                                                    ...
                                                                    in
                                                                        ''
                                                                            ${ pkgs.coreutils }/bin/ln --symbolic ${ pkgs.writeShellScript "observe.sh" ( builtins.concatStringsSep " &&\n" list ) } $out &&
                                                                                ...
                                                                                ${ pkgs.coreutils }/bin/echo ${ builtins.typeOf resources.temporary.foobar }
                                                                                exit 66
                                                                        ''
