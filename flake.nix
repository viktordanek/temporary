                                                                                        ...
                                                                                        shell-script :
                                                                                            {
                                                                                                init =
                                                                                                    shell-script
                                                                                                        {
                                                                                                            executable = let x = builtins.toPath (self + "/scripts/test/temporary/executable.sh"); in builtins.trace "x is a ${ builtins.typeOf x }" x ; in builtins.trace "x is a ${ builtins.typeOf x }" x ;
                                                                                                            environment =
