                                                                                    ...
                                                                                    reducer =
                                                                                        previous : current :
                                                                                            let
                                                                                                ...
                                                                                                in builtins.trace "HI ${ builtins.concatStringsSep " ; " ( builtins.map builtins.toString ( builtins.map builtins.length [ old-head.files new-head.files old-tail new-tail ] ) ) }" ( builtins.concatLists [ [ new-head ] new-tail ] )  ;
