                                    ...
                                    let
                                                                ...
                                                                let
                                                                    constructors =
                                                                        let
                                                                            ...
                                                                            in builtins.concatLists ( builtins.mapAttrs ( mapper [ ] ) ( builtins.trace "defined dependencies for constructors" dependencies ) ) ;
                                        ...
                                        harvest =
                                            let
                                                ...
                                                in builtins.mapAttrs ( mapper [ ] ) ( builtins.trace "defined dependencies for harvest ${ builtins.typeOf path } - ${ builtins.typeOf name } - ${ builtins.typeOf value }" dependencies ) ;
                                        in harvest ;
