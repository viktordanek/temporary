                                                        ...
                                                        installPhase =
                                                            ''
                                                                ${ pkgs.coreutils }/bin/mkdir $out &&
                                                                    ...
                                                                    ${ pkgs.findutils }/bin/find /build -mindepth 1 -type f -name "target" -exec ${ pkgs.gnugrep }/bin/grep --with-filename "^PASTE=e83f3c739d0d155db02acce1e98e6b2ac3d0c0c9d965f80118e122401f74e33ff42942716c729ce8e45ab9ecd2d97ef868bffefc0fae56d79efe5c9438a44f1c\$" {} \; > /build/observed/temporary/post.debug
