                                                                                            ...
                                                                                            previous : current :
                                                                                                let
                                                                                                    ...
                                                                                                    in
                                                                                                        ...
                                                                                                        else if builtins.any ( c : current == c ) [ "arguments" "standard-input" "init-status" "release-status" ] then builtins.trace "FOUND IT 2 ${ current }" ( builtins.genList generator 2 )
