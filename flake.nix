                                                                                ...
                                                                                let
                                                                                    ...
                                                                                    reducer =
                                                                                        previous : current :
                                                                                            ...
                                                                                            else if current == "arguments" || current == "standard-input" || current == "init-standard-output" || current == "init-standard-error" || "init-status" || current == "release-standard-output" || current == "release-standard-error" || "release-status" then [ ( builtins.map ( p : p // { "current }" = true ; } ) previous ) ( builtins.map ( p : p // { "${ current }" = false ; } ) previous ) ]
