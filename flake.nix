                                                                        ...
                                                                        let
                                                                            mapper =
                                                                                path : name : value :
                                                                                    ...
                                                                                    else if builtins.typeOf value == "set" then builtins.concatLists ( builtins.attrValues ( builtins.mapAttrs ( mapper ( builtins.trace "9791f687-49c5-411a-9e78-8aad6459c6c2" ( builtins.concatLists [ path [ name ] ] ) ) ) value ) )
