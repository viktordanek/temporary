                                                        ...
                                                        temporary =
                                                            {
                                                                temporary =
                                                                    let
                                                                        reducer = previous : current : builtins.trace "HI ${ builtins.typeOf previous } ${ builtins.typeOf current } ${ builtins.typeOf ( lib.mergeAttrs previous current.set ) }" ( lib.mergeAttrs previous current.set ) ;
