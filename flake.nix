                                                                        ...
                                                                        generator =
                                                                            ...
                                                                            index : ( builtins.trace "420" (
                                                                                let
                                                                                    ...
                                                                                    v = builtins.trace "430 ${ builtins.typeOf ( mapper ) } ${ builtins.typeOf value } ${ builtins.toJSON value } ${ builtins.typeOf index } ${ builtins.toString index } " ( builtins.elemAt value index ) ;
                                                                                    x = mapper p n v ;
