                                                                                                                                    ...
                                                                                                                                    index :
                                                                                                                                        let
                                                                                                                                            ...
                                                                                                                                            in
                                                                                                                                                ...
                                                                                                                                                then
                                                                                                                                                    ''if [ -z "${ _environment-variable "CANDIDATE_${ i }" }" ] ; then echo empty candidate ${ i } ; elif [ ! -e "${ _environment-variable "CANDIDATE_${ i }" }" ] ; then ls ${ _environment-variable "TMPDIR" } && echo non-existant candidate ${ _environment-variable "CANDIDATE_${ i }" } ; elif [ ! -z "$( cat /build/candidate.${ i }.standard-error )" ] ; then echo standard error ${ i } && cat /build/candidate.${ i }.standard-error ; fi && ${ duplicates } && ${ paste }''
                                                                                                                                                else
