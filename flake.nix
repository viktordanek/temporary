        ...
        { flake-utils , nixpkgs , self } :
            let
                fun =
                                                ...
                                                let
                                                    mapper =
                                                        path : name : value :
                                                            ...
                                                            else if builtins.typeOf value == "null" then builtins.trace "501" ( "${ resolve ( builtins.concatLists [ path [ name ] ] ) }/setup" )
                                                            else if builtins.typeOf value == "set" then builtins.mapAttrs ( mapper ( builtins.concatLists [ path [ name ] ] ) ) value
                    ...
                    resolve = path : builtins.trace "502 ${ builtins.toJSON path } ${ builtins.toJSON ( builtins.map builtins.typeOf path ) } ${ builtins.tryEval ( builtins.toString path ) }" ( builtins.concatStringsSep "/" ( builtins.map builtins.toString path ) ) ;
                    throw_new =
                        {
                            name ? builtins.null ,
                            path ,
