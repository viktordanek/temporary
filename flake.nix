                                        ...
                                        dependencies =
                                            {
                                                temporary =
                                                    let
                                                        lambda =
                                                            builtins.trace "100" ( path : ( builtins.trace "101" ( name : ( builtins.trace "102" ( value : ( builtins.trace "103" (
                                                                let
                                                                    identity =
                                                                        {
                                                                            init ? builtins.null ,
                                        ...
                                        harvest =
                                            derivation :
                                                let
                                                    mapper =
                                                        path : name : value :
                                                            if builtins.typeOf value == "lambda" then "${ resolve path name}/setup/${ derivation }"
                                                            else if builtins.typeOf value == "list" then
                                                                let
                                                                    generator =
                                                                        index :
