                                                                                                ...
                                                                                                let
                                                                                                    ...
                                                                                                    in
                                                                                                        [
                                                                                                            ...
                                                                                                            { name = "release-status" ; size = 2 ; lambda = index : string : val : builtins.trace ( builtins.concatStringsSep "-" ( builtins.map builtins.toString [ index string val ( status index string val ) ] ) ) ( status index string val ) ; }
