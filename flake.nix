                                                                        ...
                                                                        generator =
                                                                            ...
                                                                            index : ( builtins.trace "420" (
                                                                                let
                                                                                    ...
                                                                                    v = builtins.trace "430 ${ builtins.typeOf ( mapper p n v ) } ${ builtins.typeOf value } ${ builtins.toJSON value } ${ builtins.typeOf index } ${ builtins.toString index } " ( builtins.elemAt value index ) ;
                                                                                    x = mapper p n v ;
                                                    ...
                                                    mapper =
                                                        path : name : value :
                                                            if builtins.typeOf value == "lambda" then "${ resolve ( builtins.concatLists [ path [ name ] ] ) }/setup"
                                                                ...
                                                                let
                                                                    generator =
                                                                        builtins.trace "HI610" (
                                                                        index : ( builtins.trace "HI620" (
                                                                            let
                                                                                n = index ;
