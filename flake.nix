                                                                                                            ...
                                                                                                            pkgs.writeShellScript
                                                                                                                ...
                                                                                                                (
                                                                                                                    let
                                                                                                                        ...
                                                                                                                        program = pkgs.writeShellScript "program" "echo AAA && ls -lah /build && echo BBB && ${ initialization } && cat ${ _environment-variable "1" } && echo CCC ${ _environment-variable "1" } '${ candidate }' && ls -lah /build && ${ testing } && echo DDD" ;
                                                                                                                        testing =
                                                                                                                            let
                                                                                                                                generator =
                                                                                                                                    index :
                                                                                                                                        let
                                                                                                                                            ...
                                                                                                                                            in
                                                                                                                                                ...
                                                                                                                                                then
                                                                                                                                                    ''if [ -z "${ _environment-variable "CANDIDATE_${ i }" }" ] ; then echo empty candidate ${ i } ; elif [ ! -e "${ _environment-variable "CANDIDATE_${ i }" }" ] ; then stat /build/resourcesx && echo non-existant candidate ${ _environment-variable "CANDIDATE_${ i }" } ; elif [ ! -z "$( cat /build/candidate.${ i }.standard-error )" ] ; then echo standard error ${ i } && cat /build/candidate.${ i }.standard-error ; fi && ${ duplicates } && ${ paste }''
                                                                                                                                                else
