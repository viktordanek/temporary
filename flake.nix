                                                                    ...
                                                                    environment =
                                                                        { grandparent-pid , is-file , is-interactive , is-pipe , parent-pid , string , ... } :
                                                                            [
                                                                                ...
                                                                                ( parent-pid { } )
                                                                                ( string "POST" ( builtins.concatStringsSep "/" [ directory "/post" ] ) )
                                                                                ( string "RELEASE" ( builtins.concatStringsSep "/" [ directory "/release" ] ) )
                                                                                ( string "RESOURCE_MASK" "${ resource-mask }" )
                                                                                ( string "RM" "${ pkgs.coreutils }/bin/rm" )
                                                                                ( string "STANDARD_ERROR" standard-error )
                                                                                ( string "TEARDOWN_ASYNCH" ( builtins.concatStringsSep "/" [ directory "/teardown-asynch" ] ) )
                                                                                ( string "TEARDOWN_SYNCH" ( builtins.concatStringsSep "/" [ directory "/teardown-synch" ] ) )
                                                                                        ...
                                                                                        installPhase =
                                                                                            ''
                                                                                                ${ pkgs.coreutils }/bin/head --lines 21 ${ self + "/scripts/implementation/setup.sh" } > $out &&
                                                                                                    ...
                                                                                                    ${ if post then "${ pkgs.coreutils }/bin/head --lines 29 ${ self + "/scripts/implementation/setup.sh" } | ${ pkgs.coreutils }/bin/tail --lines 1 >> $out" else "#" } &&
                                                                                                            ...
                                                                                                            environment =
                                                                                                                { resource , string , temporary , ... } :
                                                                                                                    [
                                                                                                                        ...
                                                                                                                        ( string "RM" "${ pkgs.coreutils }/bin/rm" )
                                                                                                                        ( string "YQ" "${ pkgs.yq }/bin/yq" )
                                                                                                                        # ( temporary "VACUUM" ( temporary : temporary.util ) )
                                                                                                                    ] ;
                                                                                                            executable = self + "/scripts/test/temporary/post.sh" ;
                                                                                                        } ;
                                                                                            } ;
