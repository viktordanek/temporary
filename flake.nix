                                                                                    ...
                                                                                    pkgs.mkDerivation
                                                                                        {
                                                                                            installPhase =
                                                                                                let
                                                                                                    ...
                                                                                                    ultimate = "if [ -z \"$( ${ pkgs.diffutils }/bin/diff ${ d.expected } /build/observed )\" ] ; then ${ pkgs.coreutils }/bin/touch $out ; else ${ pkgs.coreutils }/bin/cat /build/observed > $out && exit 66 ; fi" ;
